...
<xsl:stylesheet version="2.0" 
  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        <title>XML Sitemap - Soccer Daily</title>
      ...
      <body>
        <div class="header">
          <h1>XML Sitemap</h1>
          <p class="desc">
            This is a generated XML Sitemap for <strong>Soccer Daily</strong>. It helps search engines like Google to index our content.
